  ...
  },
  {
    ...
    iconLinks: [
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#9003fc" xmlns="http://www.w3.org/2000/svg">
            <path d="M5.34.01A5.328 5.328 0 000 5.35v13.32A5.328 5.328 0 005.34 24h13.32A5.328 5.328 0 0024 18.67V5.35A5.328 5.328 0 0018.66.01H5.34zm6.526 2.986c2.153 0 4.112.807 5.592 2.133l-.96.96a6.243 6.243 0 00-4.63-2.05 6.247 6.247 0 00-4.634 2.052l-.962-.963a7.538 7.538 0 015.594-2.132zm0 2.285c1.49 0 2.842.581 3.845 1.524l-.963.963a4.9 4.9 0 00-2.882-.944 4.908 4.908 0 00-2.883.944l-.963-.963a6.193 6.193 0 013.846-1.524zm-.003 2.88a3.617 3.617 0 012.555 1.063 3.619 3.619 0 010 5.114 3.619 3.619 0 01-5.114 0 3.619 3.619 0 010-5.114A3.617 3.617 0 0111.863 8.16zm0 1.338a2.28 2.28 0 00-1.613.668 2.279 2.279 0 000 3.224 2.279 2.279 0 003.225 0 2.279 2.279 0 000-3.224 2.28 2.28 0 00-1.612-.668zm.002 1.532c.413 0 .747.334.747.747a.747.747 0 01-.747.747.747.747 0 01-.747-.747c0-.413.334-.747.747-.747zm-.002 1.995c.192 0 .348.156.348.348v4.312a.348.348 0 01-.695 0v-4.312c0-.192.156-.348.347-.348z"/>
          </svg>
        ),
      },
    ],
